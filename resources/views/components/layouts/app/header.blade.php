...
{{--            />--}}
{{--        </flux:tooltip>--}}
        <flux:button variant="subtle" square x-data x-on:click="$flux.dark = ! $flux.dark" aria-label="Preferred color scheme">
    ...
    @else
        <flux:navbar.item icon="log-in" :href="route('login')" :current="request()->routeIs('login')"
                          wire:navigate>
            {{ __('Login') }}
        </flux:navbar.item>
        <flux:navbar.item icon="log-in" :href="route('register')" :current="request()->routeIs('register')"
                          wire:navigate>
            {{ __('Register') }}
        </flux:navbar.item>
    @endauth
